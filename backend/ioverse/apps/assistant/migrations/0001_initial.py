# Generated by Django 5.1.2 on 2024-12-11 21:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_file', models.ImageField(blank=True, help_text='The image associated with the file.', null=True, upload_to='file_images/', verbose_name='Image File')),
                ('image_url', models.URLField(blank=True, help_text='The URL of the image associated with the file.', max_length=500, null=True, verbose_name='Image URL')),
                ('file_content', models.FileField(blank=True, help_text='Upload images or other files.', null=True, upload_to='uploaded_files/', verbose_name='File')),
                ('owner', models.ForeignKey(help_text='The user owning this model.', on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s_owned', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'File',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object', models.CharField(help_text='The object type.', max_length=50)),
                ('created_at', models.IntegerField(help_text='Unix timestamp (in seconds) for when the object was created.')),
                ('name', models.CharField(blank=True, help_text='The name of the vector store.', max_length=255, null=True)),
                ...
                ('expires_after', models.JSONField(blank=True, help_text='The expiration policy for the vector store.', null=True, validators=[apps.assistant.validators.validate_expires_after])),
                ('expires_at', models.IntegerField(blank=True, help_text='The Unix timestamp (in seconds) for when the vector store will expire.', null=True)),
                ('last_active_at', models.IntegerField(help_text='The Unix timestamp (in seconds) for when the vector store was last active.')),
