...
export default function ShareLinkDialog({ open, onClose, onConfirm, TransitionComponent }) {
  ...
  return (
    <StyledDialog open={open} onClose={onClose} TransitionComponent={TransitionComponent} maxWidth="xs" fullWidth>
      <DialogTitle
        sx={{ textAlign: 'center', fontWeight: 'bold', color: '#ffffff' }}
      >
        Set Sharing Link Duration
      </DialogTitle>
      <DialogContent>
      ...
      >
        <StyledCancelButton onClick={onClose} variant="outlined">
          Cancel
        </StyledCancelButton>
